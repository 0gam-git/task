...
public class HttpRouter {
	 ...
	 * segment (between the first and second `/`).
	 * <p>
	 *
	 ...
	 * {@link #setErrorHandler(HttpHandler)} method. The default error handler will
	 * send a `501` status code (Not Implemented) to the client.
	 *
	 * @see HttpHandler
	 */
	 ...
	 * Add a new route.
	 *
	 * @param pathSegment The first path segment ( between the first and second
	 *                    {@code /}) to match
