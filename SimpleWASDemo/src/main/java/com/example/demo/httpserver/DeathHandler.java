...
class DeathHandler extends HttpHandler {
	 ...
	 *
	 * Regardless of what you *think* we should do, we're just going to send a 500
	 * error to the browser, with a random, generic error message. Including some
	 * from our good friend, Han Solo.
	 * 
